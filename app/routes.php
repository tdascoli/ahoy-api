...
return function (App $app) {
    ...
    $app->group('/profiles', function (Group $group) {
        $group->put('', \App\Application\Actions\Profile\PostAction::class)->add(ApiKeyMiddleware::class);
    ...
    $app->group('/queue', function (Group $group) {
        $group->put('/{event_id}', \App\Application\Actions\Queue\PostAction::class)->add(ApiKeyMiddleware::class);
